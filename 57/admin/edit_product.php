...
if (isset($_POST["sbm"])){
    ...
    else{$prd_image = $_FILES["prd_image"]["name"];
...
echo $sql = "UPDATE product SET prd_name = '$prd_name', prd_price = $prd_price, prd_warranty = '$prd_warranty', prd_accessories = '$prd_accessories', prd_promotion = '$prd_promotion', prd_new = '$prd_new', prd_image = '$prd_image', cat_id = $cat_id, prd_status = $prd_status, prd_featured = $prd_featured, prd_details = '$prd_details'
WHERE prd_id = $prd_id";
$query = mysqli_query($conn, $sql);
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Sản phẩm số <?php echo $row['prd_id']; ?></li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Sản phẩm: Sản phẩm số <?php echo $row['prd_id']; ?></h1>
			</div>
        </div><!--/.row-->
        <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <img width="160" height="212" src="img/<?php echo $row['prd_image'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
