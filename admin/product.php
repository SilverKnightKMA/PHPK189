                ...
                <div class="panel-body">
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            $list_pages .= '<li class="page-item"><a class="page-link" href="index.php?page_layout=product&page=' . $page_prev . '">Trước</a></li>';
                            ...
                            $list_pages .= '<li class="page-item"><a class="page-link" href="index.php?page_layout=product&page=' . $page_next . '">Sau</a></li>
                                </ul>
                            </nav>';
